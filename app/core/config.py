...
class Settings(BaseSettings):
    ...
    aws_default_region: str = Field(default="ap-south-1", alias="AWS_DEFAULT_REGION")
    
    # Barcode Processing Configuration
    min_barcode_width: int = Field(default=150, alias="MIN_BARCODE_WIDTH")
    min_barcode_height: int = Field(default=100, alias="MIN_BARCODE_HEIGHT")
