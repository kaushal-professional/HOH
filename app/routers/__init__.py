...
from app.routers import shop, product, store_product_flat, article_code, pos_entry, stock_take, product_management, price_pos, price_consolidated
...
__all__ = ["api_router", "shop", "product", "store_product_flat", "article_code", "price_pos", "price_consolidated", "pos_entry", "stock_take", "product_management"]
