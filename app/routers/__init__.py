...
from app.routers import shop, product, store_product_flat, article_code, pos_entry, stock_take, product_management, price_pos, price_consolidated, login, pos_retrieval
...
api_router.include_router(pos_retrieval.router)  # POS Data Retrieval for Admin
...
__all__ = ["api_router", "login", "shop", "product", "store_product_flat", "article_code", "price_pos", "price_consolidated", "pos_entry", "stock_take", "product_management", "pos_retrieval"]
