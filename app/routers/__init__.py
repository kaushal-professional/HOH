...
from app.routers import shop, product, store_product_flat, article_code, pos_entry, stock_take, product_management
...
__all__ = ["api_router", "shop", "product", "store_product_flat", "article_code", "pos_entry", "stock_take", "product_management"]
