...
class POSEntryListItem(BaseModel):
    """Simplified POS Entry for list view"""
    id: UUID
    note_date: date
    promoter_name: str
    store_name: Optional[str]
...
class POSEntryListResponse(BaseModel):
    """Response schema for list of POS entries with pagination"""
    entries: List[POSEntryListItem]
    total: int
    page: int
    page_size: int
    total_pages: int
