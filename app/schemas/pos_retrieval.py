...
class POSDataItem(BaseModel):
    ...
    taxes: Optional[Decimal] = Field(default=None, description="GST/Tax amount")
    price_excluding_tax: Decimal = Field(..., description="Price excluding tax")
    price_including_tax: Optional[Decimal] = Field(default=None, description="Price including tax")
