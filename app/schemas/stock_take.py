...
class StockVarianceItem(BaseModel):
    ...
    start_date: datetime = Field(..., description="Start date timestamp (from open_stock created_at)")
    end_date: datetime = Field(..., description="End date timestamp (from close_stock created_at)")
...
class StockVarianceDownloadResponse(BaseModel):
    ...
    store_name: Optional[str] = Field(None, description="Store name filter (null if all stores)")
    start_date: Optional[datetime] = Field(None, description="Filter start date timestamp")
    end_date: Optional[datetime] = Field(None, description="Filter end date timestamp")
